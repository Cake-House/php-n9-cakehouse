...
<table border=1 class="mt-5 ml-5 h-[300px]">
    ...
    <tr class="border-2">
        ...
        <th class="w-[90px] text-center border-2">Address</th>
    ...
    <tr class="border-2">
        ...
        <td class="h-[100px] w-[100px] text-center border-2"><img src="modules/quanlytaikhoan/uploads/<?php echo $row['avatar'] ?>" alt="Avatar" width="100px"></td>
        ...
        <td class="h-[100px] w-[90px] text-center border-2"><?php echo $row['address'] ?></td>
