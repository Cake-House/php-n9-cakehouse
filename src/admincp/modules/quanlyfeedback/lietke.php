...
<table border=1 class="mt-5 ml-5 h-[100px]">
    ...
    <tr class="border-2">
        ...
        <td class="h-[100px] w-[90px] text-justify border-2" ><?php echo $row['note'] ?></td>
        <td class="h-[100px] w-[90px] text-center border-2" ><?php echo $row['created_at'] ?></td>
        <td class="h-[100px] w-[90px] text-center border-2" ><?php echo $row['updated_at'] ?></td>
    <?php
    }
    ?>
</table>